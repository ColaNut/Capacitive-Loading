...
switch point_idx
    case 1
        A_row( p1 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p + 1) ) + Epsilon_0 * d_x * d_y / ( 2 * d_z(p + 1) ); % ell + 1
        A_row( p2 ) = epsilon_b * d_y * d_z(p + 1) / (4 * d_x) ...
            + epsilon_b * d_y * d_z(p) / (4 * d_x) + Epsilon_0 * d_y * ( d_z(p) + d_z(p + 1) ) / (4 * d_x); % m - 1
        A_row( p3 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p) ) ...
        ...
        A_row( p6 ) = epsilon_b * d_x * d_z(p + 1) / (4 * d_y) ...
    ...
    case 2
        A_row( p1 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p + 1) ) ...
        ...
        A_row( p3 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p) ) ...
            + Epsilon_0 * d_x * d_y / ( 2 * d_z(p) ); % ell - 1
        A_row( p4 ) = Epsilon_0 * d_y * ( d_z(p) + d_z(p + 1) ) / (2 * d_x); % m + 1
        A_row( p5 ) = epsilon_b * d_x * d_z(p + 1) / (4 * d_y) ...
            + epsilon_b * d_x * d_z(p) / (4 * d_y) + Epsilon_0 * d_x * ( d_z (p) + d_z(p + 1) ) / (4 * d_y);  % n + 1
    ...
    case 3
        ...
        A_row( p3 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p) ) ...
            + Epsilon_0 * d_x * d_y / ( 2 * d_z(p) ); % ell - 1
        A_row( p4 ) = epsilon_b * d_y * d_z(p + 1) / (4 * d_x) ...
            + epsilon_b * d_y * d_z(p) / (4 * d_x) + Epsilon_0 * d_y * ( d_z(p) + d_z(p + 1) ) / (4 * d_x); % m + 1
        A_row( p5 ) = Epsilon_0 * d_x * ( d_z(p) + d_z(p + 1) ) / (2 * d_y); % n + 1
        A_row( p6 ) = epsilon_b * d_x * d_z(p + 1) / (4 * d_y) ...
            + epsilon_b * d_x * d_z(p) / (4 * d_y) + Epsilon_0 * d_x * ( d_z (p) + d_z(p + 1) ) / (4 * d_y);  % n - 1
