...
switch point_idx
    case 1
        ...
        A_row(6)  = p6;
        A_row(7)  = p0;
        A_row(8)  = ( Epsilon_0 + Epsilon_0 ) * d_x * d_y / ( 4 * d_z_10 ) + Epsilon_0 * d_x * d_y / ( 2 * d_z_10 ); % ell + 1
        A_row(9)  = Epsilon_0 * d_y * d_z_10 / (4 * d_x) + epsilon_b * d_y * d_z(p) / (4 * d_x) + Epsilon_0 * d_y * ( d_z(p) + d_z_10 ) / (4 * d_x); % m - 1
        ...
        A_row(13) = Epsilon_0 * d_x * d_z_10 / (4 * d_y) + epsilon_b * d_x * d_z(p) / (4 * d_y) + Epsilon_0 * d_x * ( d_z (p) + d_z_10 ) / (4 * d_y);  % n - 1
    ...
    case 3
        ...
        A_row(10) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 4 * d_z(p) ) + Epsilon_0 * d_x * d_y / ( 2 * d_z(p) ); % ell - 1
        A_row(11) = Epsilon_0 * d_y * d_z_10 / (4 * d_x) + epsilon_b * d_y * d_z(p) / (4 * d_x) + Epsilon_0 * d_y * ( d_z(p) + d_z_10 ) / (4 * d_x); % m + 1
        A_row(12) = Epsilon_0 * d_x * ( d_z(p) + d_z_10 ) / (2 * d_y); % n + 1
        A_row(13) = Epsilon_0 * d_x * d_z_10 / (4 * d_y) + epsilon_b * d_x * d_z(p) / (4 * d_y) + Epsilon_0 * d_x * ( d_z (p) + d_z_10 ) / (4 * d_y);  % n - 1
        A_row(14) = - ( A_row( 8 ) + A_row( 9 ) + A_row( 10 ) + A_row( 11 ) + A_row( 12 ) + A_row( 13 ) ); % center point
    case 4
