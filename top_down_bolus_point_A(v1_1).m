function [ A_row ] = top_down_bolus_point_A( point_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon, epsilon_b, Epsilon_0 )
...
switch point_idx
    case 1
        ...
        A_row( p3_down ) = 3 * Epsilon_0 * d_x * d_y / (4 * d_z(p)); % ell - 2
    ...
    case 5
        ...
        A_row( p1_up ) = 3* Epsilon_0 * d_x * d_y / (4 * d_z(p)); % ell - 2
