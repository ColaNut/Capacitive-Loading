...
%         A( idx, : ) = top_down_bolus_line_A( top_down_bolus_line_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon_r, epsilon_b_r, epsilon_0_r );
%     end
...
%         A( idx, : ) = top_down_bolus_point_A( top_down_bolus_point_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon_r, epsilon_b_r, epsilon_0_r );
%     end

%     top_down_air_idx = check_top_down_air_valid( m, n, ell, N_p, p, M_x, M_x1, M_x2, M_x3, M_x4, M_x5, M_y, M_y1, M_y2, M_y3, M_y4, M_y5 );
%     if top_down_air_idx
%         A( idx, : ) = top_down_air_A( top_down_air_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon_r, epsilon_b_r, epsilon_0_r );
%     end
...
%         A( idx, : ) = top_down_air_line_A( top_down_air_line_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon_r, epsilon_b_r, epsilon_0_r );
%     end
...
%         A( idx, : ) = top_down_air_point_A( top_down_air_point_idx, p, p0, p1, p2, p3, p4, p5, p6, p1_up, p3_down, M_x_max, M_y_max, N_max, d_x, d_y, d_z, epsilon_r, epsilon_b_r, epsilon_0_r );
%     end
% end
% toc;
