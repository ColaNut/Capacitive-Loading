function [ A_row ] = air_vertical_line_10_A( line_idx, p, p0, p1, p2, p3, p4, p5, p6, M_x_max, M_y_max, N_max, N_10, N_da, d_x, d_y, d_z, d_z_da, epsilon, epsilon_b, Epsilon_0 )

A_row = zeros( 1, M_x_max * M_y_max * ( N_da + N_max + N_10 ) );
    
switch line_idx
    case 1
        A_row( p0 ) = ( -2 ) * ( (1 / d_z_da)^2 ); % center point
