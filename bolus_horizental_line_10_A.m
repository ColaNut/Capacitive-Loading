...
switch line_idx
    case 1
        A_row( p1 ) = ( Epsilon_0 + Epsilon_0 ) * d_x * d_y / ( 2 * d_z_10 ); % ell + 1
        ...
        A_row( p5 ) = Epsilon_0 * d_x * d_z_10 / (4 * d_y) + ...
    ...
    case 2
        ...
        A_row( p3 ) = ( epsilon_b + Epsilon_0 ) * d_x * d_y / ( 2 * d_z(p) ); % ell - 1
        A_row( p4 ) = Epsilon_0 * d_y * d_z_10 / (2 * d_x) + epsilon_b * d_y * d_z(p) / (2 * d_x); % m + 1
    ...
    case 3
        A_row( p1 ) = ( Epsilon_0 + Epsilon_0 ) * d_x * d_y / ( 2 * d_z_10 ); % ell + 1
        A_row( p2 ) = Epsilon_0 * d_y * d_z_10 / (4 * d_x) ...
        ...
        A_row( p6 ) = Epsilon_0 * d_x * d_z_10 / (2 * d_y) + epsilon_b * d_x * d_z(p) / (2 * d_y); % n - 1
        A_row( p0 ) = - ( A_row( p1 ) + A_row( p2 ) + A_row( p3 ) + A_row( p4 ) + A_row( p5 ) + A_row( p6 ) ); % center point
    case 4
        A_row( p1 ) = ( Epsilon_0 + Epsilon_0 ) * d_x * d_y / ( 2 * d_z_10 ); % ell + 1
        A_row( p2 ) = Epsilon_0 * d_y * d_z_10 / (4 * d_x) ...
